        ...
        switch (ev.type) {
            ...
            case ALLEGRO_EVENT_MOUSE_BUTTON_DOWN:
                ...
                if (((ev.mouse.button & 1) && (mouseX >= 255) && (mouseX <= 545) && (mouseY >= 450) && (mouseY <= 520) &&
                    ...
                    if (listaBolas != NULL && listaBlocos != NULL) {
                ...
                if ((ev.mouse.button & 1) && (mouseX >= 255) && (mouseX <= 545) && (mouseY >= 560) && (mouseY <= 630) &&
                    (estadoAtual == MENU))
                    estadoAtual = SCORES;

                if ((ev.mouse.button & 1) && (mouseX >= 340) && (mouseX <= 460) && (mouseY >= 700) && (mouseY <= 820) &&
